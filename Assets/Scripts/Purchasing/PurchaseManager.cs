...
public class PurchaseManager : Singleton<PurchaseManager>, IStoreListener
{
    ...
    {
        NC_PRODUCTS = PurchasingProductDefinition.NonConsumable.GetAll();
        C_PRODUCTS = PurchasingProductDefinition.Consumable.GetAll();
    }
    ...
    public void BuyConsumable(string id)
    {
        ...
        BuyProductID(C_PRODUCTS[currentProductIndex]);
    }
